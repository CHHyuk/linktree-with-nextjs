...
export const allButtons = [
  { key: 'email', 'label': 'e-mail', icon: faEnvelope, placeholder: 'input email' },
  { key: 'mobile', 'label': 'mobile', icon: faMobile, placeholder: 'input phone number' },
  { key: 'instagram', 'label': 'instagram', icon: faInstagram, placeholder: 'input instagram url' },
  { key: 'facebook', 'label': 'facebook', icon: faFacebook, placeholder: 'input facebook url'},
  { key: 'discord', 'label': 'discord', icon: faDiscord, placeholder: 'input discord url' },
  { key: 'tiktok', 'label': 'tiktok', icon: faTiktok, placeholder: 'input tictok url' },
  { key: 'youtube', 'label': 'youtube', icon: faYoutube, placeholder: 'input youtube channel url'},
  { key: 'whatsapp', 'label': 'whatsapp', icon: faWhatsapp, placeholder : 'input whatsapp url'},
  { key: 'github', 'label': 'github', icon: faGithub, placeholder: 'input github url'},
  { key: 'telegram', 'label': 'telegram', icon: faTelegram, placeholder: 'input telegram id'},
];
